...
| Column                     | Data Type      | Constraints                     | Description                                         |
|----------------------------|----------------|---------------------------------|-----------------------------------------------------|
| organization_id            | SERIAL         | PRIMARY KEY                     | Unique identifier for the organization.             |
| organization_name          | VARCHAR(255)   | NOT NULL, UNIQUE                | Unique name of the organization.                    |
| organization_description   | VARCHAR(255)   | NOT NULL, UNIQUE                | Unique name of the organization.                    |
